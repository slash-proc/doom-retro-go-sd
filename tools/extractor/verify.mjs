...
export const DEFAULT_POLICY = {
  ...
  // 8192 pages = 512 MiB. Measured, not copied: the module peaks at 3571 pages
  // (223 MiB) converting Doom II, the largest IWAD available to test. 4096
  // would leave 525 pages of headroom, too thin to promise when TNT and
  // Plutonia are larger WADs than Doom II and were not measured.
  maxMemoryPages: 8192,      // 512 MiB ceiling on declared memory growth
